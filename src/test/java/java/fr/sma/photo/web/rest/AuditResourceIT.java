...
import java.fr.sma.photo.config.audit.AuditEventConverter;
import java.fr.sma.photo.domain.PersistentAuditEvent;
import java.fr.sma.photo.repository.PersistenceAuditEventRepository;

import java.fr.sma.photo.service.AuditEventService;
